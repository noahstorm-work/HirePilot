    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-[#09090b]">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#63636e] mt-2">Sign in to your career cockpit</p>
        </div>
        ...
        <div className="p-8 rounded-2xl border border-[#1e1e24] bg-[#0f0f12]">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0f0f12] px-3 text-[#45454e]">or</span>
            </div>
          </div>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full border-[#27272f] text-[#a0a0ab] hover:text-[#fafafa] hover:bg-[#16161a] h-11 font-medium group"
          >
