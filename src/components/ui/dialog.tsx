...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-[#fafafa] font-[family-name:var(--font-display)]", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-[#63636e]", className)}
    {...props}
  />
))
