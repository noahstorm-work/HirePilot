...
- Name: applications.spec.ts >> Applications Redirect >> unauthenticated user is redirected from applications to login
- Location: tests\e2e\applications.spec.ts:12:7
